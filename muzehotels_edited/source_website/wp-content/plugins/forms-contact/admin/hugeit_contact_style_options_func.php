...
('form_button_reset_font_hover_color', 'Form Button Reset Font Hover Color', 'Form Button Reset Font Hover Color', '".$style_id."' , 'ec248e'),
...
('form_button_submit_hover_background', 'Form Button Submit Hover Background', 'Form Button Submit Hover Background', '".$style_id."' , 'ec248e'),
...
('form_file_border_color', 'Form File Border Color', 'Form File Border Color', '".$style_id."' , 'bd1d72'),
...
('form_input_text_border_color', 'Form Input Text Border Color', 'Form Input Text Border Color', '".$style_id."' , 'bd1d72'),
...
('form_border_color', 'Form Border Color', 'Form Border Color', '".$style_id."' , 'bd1d72'),
