<?php
    ...
    function jellythemes_scripts_and_styles() {
        ...
        if (!is_admin()) {
            ...
            wp_enqueue_style( 'site', get_template_directory_uri() . '/css/site.css' );
             ...
             wp_enqueue_style( 'responsive-default', get_template_directory_uri() . '/css/responsive-default.css' );
            ...
            wp_enqueue_script(
                'anchor',
                get_template_directory_uri() . '/js/anchor.js',
                array('jquery'),false,true );
            wp_enqueue_script(
                'classie',
            ...
            wp_enqueue_script(
                'masterslider',
                get_template_directory_uri() . '/js/masterslider.min.js',
                array('jquery'),false,true );
            wp_enqueue_script(
                'inview',
            ...
            wp_enqueue_script(
              ...
              wp_enqueue_script(
                'stickonscroll',
                get_template_directory_uri() . '/js/jquery.stickOnScroll.js',
                array('jquery'),false,true );
            ...
            wp_enqueue_script(
                'ellipsis',
                get_template_directory_uri() . '/js/jquery.ellipsis.min.js',
                array('jquery'),false,true );
    ...
    class jellythemes_walker_nav_menu extends Walker_Nav_Menu {
        ...
        function start_el( &$output, $item, $depth = 0, $args = array(), $curr = 0 ) {
            ...
            $attributes .= ' class="menu-link anchor' . ( $depth > 0 ? 'sub-menu-link' : 'main-menu-link anchor' ) . '"';
